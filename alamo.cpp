...
void startupOutput(string fag, int sleep1, int sleep2, int fastSleep)
{
	string text = "Hello this is your weekly alamo reminder\n\n\nThe alamo is texas's greatest day here is your reminder\n\n\nPress any key to continue . . . ";
...
void giveAlamoInfo(string fag, int sleep1, int sleep2, int fastSleep)
{
...
void gayInput(string & rate, int sleep1, int sleep2, int fastSleep)
{
...
{
	string fag;
	int sleep1 = 1000, sleep2 = 500, fastSleep = 5;
	startupOutput(fag, sleep1, sleep2, fastSleep);
	giveAlamoInfo(fag, sleep1, sleep2, fastSleep);
	getSurvey(sleep1, sleep2, fastSleep);
	getline(cin, fag);
	cout << endl;
}
